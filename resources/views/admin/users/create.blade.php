                        ...
                        <form class="form" method="POST" action="{{ route('admin.users.store') }}">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 form-group">
                                        <label>Email:</label>
                                        <input type="email" class="form-control @error('email') is-invalid @enderror" placeholder="Enter email address" name="email" required />
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-lg-6 form-group">
                                        ...
                                        <a href="{{ route('admin.users.index') }}" type="button" class="btn btn-secondary">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </form>
