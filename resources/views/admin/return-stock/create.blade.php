...
@section('content')
    <div class="card">
        <form id="formData" method="POST" action="{{ route('admin.return-stock.store') }}">
            @csrf
            <div class="card-header">
                <h4>Create Return Stock</h4>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <label for="date" class="required">Return Stock No:</label>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="btn-group" role="group" aria-label="payment_type">
                            <input type="hidden" name="pay_type" value="{{ $paymentType}}">
                        </div>
        ...
        $(document).ready(function() {
            ...
            function addRow() {
                ...
                <tr class="rows">
                    ...
                    <td class="price">
                        <input type="text" name="price[]" class="form-control sellPrice text-right">
                    </td>
                    <td class="total">
            ...
            $("#submit-form").click(function(e) {
                ...
                if(totalBill == 0)
                {
                    toastr.error('Total Bill should not be 0');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status == true) {
                            ...
                            setTimeout(function() {
                                window.location.href = "{{ route('admin.return-stock.index') }}"
                            }, 1000);
                        } else {
                            if (response.errors) {
            ...
            $(document).on("input", ".sellPrice", function() {
