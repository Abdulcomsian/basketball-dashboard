    ...
    @else
        ...
        <table class="main-table" width="100%">
            <thead>
                <tr>
                    ...
                    <th width="20%" class="my-font-family">Supplier</th>
        ...
        @forelse ($data as $purchaseOrder)
            ...
            @php
                ...
                $grandTotal += $purchaseOrder['total_bill'] ?? 0;
            ...
            <table class="table2" width="100%">
                <thead>
                    <tr>
                        <td width="19%" class="my-font-family">{{ $purchaseOrder['stock_number'] ?? '' }}</td>
                        <td width="17%" class="my-font-family">{{ date('d/m/Y', strtotime($purchaseOrder['order_date'] ?? '')) }}</td>
                        <td width="20%" class="my-font-family">{{ $purchaseOrder['supplier']['name'] ?? '' }}</td>
                        <td class="my-font-family">{{ $purchaseOrder['pay_type'] ?? '' }}</td>
                    </tr>
                </thead>
            </table>
            ...
            <table class="table3" width="100%">
                ...
                <tbody>
                    ...
                    @forelse ($purchaseOrder['add_stock_logs'] as $purchaseOrderLog)
                        
                   
                        <tr>
                            <td width="14%" class="my-font-family">{{ $purchaseOrderLog['product']['barcode'] ?? '' }}</td>
                            <td width="15%" class="my-font-family">{{ $purchaseOrderLog['warehouse']['abbreviation'] ?? '' }}</td>
                            <td width="22%" class="my-font-family">{{ $purchaseOrderLog['product']['name'] ?? '' }}</td>
                            <td width="7%" class="my-font-family text-align-center">{{ $purchaseOrderLog['unit_type']['abbreviation'] ?? '' }}</td>
                            <td width="8%" class="my-font-family text-align-center">{{ $purchaseOrderLog['unit_qty'] ?? '' }}</td>
                            <td width="15%" class="my-font-family text-align-center">{{ numberFormat($purchaseOrderLog['price'] ?? '') }}</td>
                            <td class="my-font-family text-align-right">{{ numberFormat($purchaseOrderLog['total'] ?? '') }}</td>
                        </tr>
                    ...
                    <tr>
                        ...
                        <th class="my-font-family text-align-right">
                            ...
                            <span>
                                ...
                                {{ numberFormat($purchaseOrder['total_bill'] ?? '') }}
